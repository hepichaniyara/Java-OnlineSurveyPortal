...
body { 
  ...
  font-family: Arial, Helvetica, sans-serif;
   ...
   background-image: url(images/addcomp.gif);
...
<div>
<h1 align="center">Add Competition for Students</h1><br>
<%-- <form action="CompetitionCtrl" method="post">
<table class="table"
style="color: maroon;">
<tr>
...
<tr>
<td>Volunteer</td>
<td><input type="text" name="volunteer" placeholder="Volunteer" required></td>
</tr>
<tr>
<td>Date</td>
<td> <input type="text" name="dos" id="datepicker" placaholder="dos"></td>
</tr>
...
<tr>
<td></td>
<td><input type="submit" name="Action" value="Add" class="btn-danger"></td>
</tr>
</table>
</form> --%>
                    ...
                    <div id="login-box" class="col-md-12" >
                      ...
                      <form action="CompetitionCtrl" method="post">
                            ...
                            <div class="form-group">
                                <label for="username" class="text-info">Competition Name</label><br>
                          ...
                          <strong><span style="color:red"><%=(request.getAttribute("isname") == null) ? "" : request.getAttribute("isname")%></span>
                           ...
                           <strong><span style="color:red"><%=(request.getAttribute("isvolunteer") == null) ? "" : request.getAttribute("isvolunteer")%></span>
</strong>
                            </div>
                            ...
                            <div class="form-group" align="center" >
                               <!--  <label for="remember-me" class="text-info"><span>Remember me</span> <span><input id="remember-me" name="remember-me" type="checkbox"></span></label><br> -->
                                <input type="submit" name="Action" class="btn btn-info btn-md" value="Add"> 
