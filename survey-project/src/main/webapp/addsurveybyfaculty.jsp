...
body { 
  ...
  font-family: Arial, Helvetica, sans-serif;
   background-image: url(images/surveyteacher.gif);
...
%> --%>
<div>
<h1 align="center">Add Survey for Students</h1><br>
<%-- <form action="AddSurveyByFacultyCtrl" method="post">
...
<strong><span style="color:red"><%=(request.getAttribute("ermsg") == null) ? "" : request.getAttribute("ermsg")%></span></strong>
</td>
</tr>
<tr>
<td>Date</td>
...
<td><input type="text" name="venue" placaholder="venue" required></td>
 ...
 <tr>
        <td><strong><span style="color:red"><%=(request.getAttribute("msg") == null) ? "" : request.getAttribute("msg")%></span></strong></td>
<tr>
<td></td>
<td><input type="submit" name="Action" value="Add Survey" class="btn-danger"></td>
</tr>
</table>
</form> --%>
