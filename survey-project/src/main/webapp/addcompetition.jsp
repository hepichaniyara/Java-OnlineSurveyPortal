...
<div>
<h1 align="center" style="color: maroon;">Add Competition for Students</h1>
...
<tr>
<td></td>
<td><input type="submit" name="Action" value="Add Competiton"></td>
</tr>
</table>
</form> --%>
</div>
                           ...
                           <strong><span style="color:red"><%=(request.getAttribute("ermsg") == null) ? "" : request.getAttribute("ermsg")%></span>
                            ...
                            <div class="form-group" align="center" >
                               <!--  <label for="remember-me" class="text-info"><span>Remember me</span> <span><input id="remember-me" name="remember-me" type="checkbox"></span></label><br> -->
                                <input type="submit" name="Action" class="btn btn-info btn-md" value="Add Competiton"> 
