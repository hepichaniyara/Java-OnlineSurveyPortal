...
<td><a href="editstudentsurvey.jsp?id=<%=resultSet.getInt(1) %>"  name="Action" value="Edit" class="btn btn-primary">Edit</a>
<%--  <input type="hidden" name="j" value="<%=resultSet.getInt(1)%>"> --%>

<a href="deletestudentsurvey.jsp?id=<%=resultSet.getInt(1)%>" name="Action" value="Delete" class="btn btn-danger">Delete</a>
